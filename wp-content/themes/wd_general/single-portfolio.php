							...
							<div <?php post_class("single-post");?>>
								...
								<div class="post_inner">	
									...
									<div class="post-info-meta-top post-info-meta">
										...
										<?php endif; ?>
										<?php if( absint($tvlgiao_wpdance_wd_data['wd_blog_details_time']) == 1 ) : ?>			
								...
								<!--Category List-->
										...
										?>
											<div class="categories">
												<span class="cat-links">
													<?php printf( wp_kses_post(__( '<span class="%1$s heading-title">Categories:</span> %2$s', 'wpgeneral' )), 'entry-utility-prep entry-utility-prep-cat-links', $categories );?>
												</span>
											</div>
											<?php
										}
									...
									<?php if( absint($tvlgiao_wpdance_wd_data['wd_blog_details_tags']) == 1 ) : ?>
											...
											?>
												<div class="tags">
													...
													<span class="tag-links">
														<?php //_e( '<span class="entry-utility-prep entry-utility-prep-tag-links"></span>'.$tags_list, 'wpgeneral' );  ?>
														<?php printf( wp_kses_post(__( '<span class="%s"></span>: %s', 'wpgeneral' )), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list );
														$show_sep = true; ?>
													</span>
													
													<?php if( absint($tvlgiao_wpdance_wd_data['wd_blog_details_socialsharing']) == 1 ) : ?>
														<ul  class="share-list">
															<li>
																<div id="fb-root"></div>
								...
								<?php if($tvlgiao_wpdance_wd_data['wd_bottom_blog_code'] != 'null') echo stripslashes($tvlgiao_wpdance_wd_data['wd_bottom_blog_code']);?>	
								</div>
