...
function wd_edit_category_fields( $term, $taxonomy ){
	...
	//$datas = get_term_meta( $term->term_id, "cat_config", true );
	$datas = get_woocommerce_term_meta( $term->term_id, "cat_config", true );
	if( strlen($datas) > 0 ){
...
function wd_category_fields_save( $term_id, $tt_id, $taxonomy ){
	...
	//$result = update_term_meta($term_id,"cat_config",$_term_config_str );
	$result = update_woocommerce_term_meta( $term_id,"cat_config",$_term_config_str );

}

function wd_category_fields_remove( $term_id, $tt_id, $taxonomy ){
	//delete_metadata( 'woocommerce_term',$term_id,"cat_config" );
	delete_woocommerce_term_meta( $term_id,"cat_config" );
}
...
function wd_tag_fields_save( $term_id, $tt_id, $taxonomy ){
  ...
  $result = update_term_meta($term_id,"tag_config",$_term_config_str );
