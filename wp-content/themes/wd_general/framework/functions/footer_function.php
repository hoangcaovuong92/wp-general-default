<?php 
	...
	add_action( 'tvlgiao_wpdance_wd_footer_init', 'tvlgiao_wpdance_wd_footer_init_widget_area_5', 30 );
	if(!function_exists ('tvlgiao_wpdance_wd_footer_init_widget_area_5')){
		function tvlgiao_wpdance_wd_footer_init_widget_area_5(){
		global $tvlgiao_wpdance_wd_data;
	?>	
			<div class="fourth-footer-area" >
				<div class="container">
					...
					<div id="copy-right" class="copy-right">						
						<?php if(isset($tvlgiao_wpdance_wd_data['wd_center_align_fourth_footer_area']) && absint($tvlgiao_wpdance_wd_data['wd_center_align_fourth_footer_area']) == 1):?>
						<div class="payment text-center">
							<ul>
								<?php if( strlen($tvlgiao_wpdance_wd_data['wd_payment_image_1']) > 0 && (int)$tvlgiao_wpdance_wd_data['wd_show_payment_image_1'] == 1 ): ?>
								<li><a href="#"><img alt="payment 1" title ="payment 1" src="<?php echo esc_url($tvlgiao_wpdance_wd_data['wd_payment_image_1']); ?>" /></a></li>
								<?php endif; ?>
								<?php if( strlen($tvlgiao_wpdance_wd_data['wd_payment_image_2']) > 0 && (int)$tvlgiao_wpdance_wd_data['wd_show_payment_image_2'] == 1 ): ?>
								<li><a href="#"><img alt="payment 2" title ="payment 2" src="<?php echo esc_url($tvlgiao_wpdance_wd_data['wd_payment_image_2']); ?>" /></a></li>
								<?php endif; ?>
								<?php if( strlen($tvlgiao_wpdance_wd_data['wd_payment_image_3']) > 0 && (int)$tvlgiao_wpdance_wd_data['wd_show_payment_image_3'] == 1 ): ?>
								<li><a href="#"><img alt="payment 3" title="payment 3" src="<?php echo esc_url($tvlgiao_wpdance_wd_data['wd_payment_image_3']); ?>" /></a></li>
								<?php  endif; ?>
								<?php if( strlen($tvlgiao_wpdance_wd_data['wd_payment_image_4']) > 0 && (int)$tvlgiao_wpdance_wd_data['wd_show_payment_image_4'] == 1 ): ?>
								<li><a href="#"><img alt="payment 4" title="payment 4" src="<?php echo esc_url($tvlgiao_wpdance_wd_data['wd_payment_image_4']); ?>" /></a></li>
								<?php endif; ?>
								<?php if( strlen($tvlgiao_wpdance_wd_data['wd_payment_image_5']) > 0 && (int)$tvlgiao_wpdance_wd_data['wd_show_payment_image_5'] == 1 ): ?>
								<li><a href="#"><img alt="payment 5" title="payment 5" src="<?php echo esc_url($tvlgiao_wpdance_wd_data['wd_payment_image_5']); ?>" /></a></li>
								<?php endif; ?>
							</ul>
						</div>
						<div class="copyright">
							<?php echo do_shortcode(stripslashes($tvlgiao_wpdance_wd_data['footer_text'])); ?>
						</div>
						<?php else:?>
