...
function tvlgiao_wpdance_my_page_template_redirect(){
	global $wp_query,$tvlgiao_wpdance_page_datas,$post,$tvlgiao_wpdance_wd_data;
	...
	if($wp_query->is_page()){
		global $tvlgiao_wpdance_custom_style_config,$tvlgiao_wpdance_page_datas,$tvlgiao_wpdance_wd_data;
		$tvlgiao_wpdance_page_datas = unserialize(get_post_meta($post->ID,TVLGiao_Wpdance_THEME_SLUG.'page_configuration',true));
		$tvlgiao_wpdance_page_datas = wd_array_atts(array(	
											"page_layout" 			=> '0'
		...
		$tvlgiao_wpdance_wd_data['wd_layout_style'] = strcmp($tvlgiao_wpdance_page_datas['page_layout'],'0') == 0 ? (isset($tvlgiao_wpdance_wd_data['wd_layout_styles']) ? $tvlgiao_wpdance_wd_data['wd_layout_styles'] : 'wide' ) : $tvlgiao_wpdance_page_datas['page_layout'] ;
		$tvlgiao_wpdance_wd_data['wd_layout_header'] = (strcmp($tvlgiao_wpdance_page_datas['page_layout'],'0')== 0 || strcmp($tvlgiao_wpdance_page_datas['header_layout'],'wide') == 0) ? (isset($tvlgiao_wpdance_wd_data['wd_layout_styles']) ? $tvlgiao_wpdance_wd_data['wd_header_styles'] : 'wide' ) : $tvlgiao_wpdance_page_datas['header_layout'] ;
		$tvlgiao_wpdance_wd_data['wd_layout_main_content'] = (strcmp($tvlgiao_wpdance_page_datas['page_layout'],'0')== 0 || strcmp($tvlgiao_wpdance_page_datas['main_content_layout'],'wide') == 0) ? (isset($tvlgiao_wpdance_wd_data['wd_maincontent_styles']) ? $tvlgiao_wpdance_wd_data['wd_maincontent_styles'] : 'wide' ) : $tvlgiao_wpdance_page_datas['main_content_layout'] ;
		$tvlgiao_wpdance_wd_data['wd_layout_footer'] = (strcmp($tvlgiao_wpdance_page_datas['page_layout'],'0')== 0 || strcmp($tvlgiao_wpdance_page_datas['footer_layout'],'wide') == 0) ? (isset($tvlgiao_wpdance_wd_data['wd_footer_styles']) ? $tvlgiao_wpdance_wd_data['wd_footer_styles'] : 'wide' ) : $tvlgiao_wpdance_page_datas['footer_layout'] ;
	...
	if( is_tax( 'product_cat' ) ){
		...
		$_term_config = get_woocommerce_term_meta( $term->term_id, "cat_config", true );
