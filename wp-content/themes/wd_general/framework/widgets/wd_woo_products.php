...
if(!class_exists('WP_Widget_Wd_Woo_Products')){
	class WP_Widget_Wd_Woo_Products extends WP_Widget {
		function __construct() {
	    	$widget_setting = array(
				'name' 		=> esc_html__('WD - Woocommerce Products','wpgeneral'),
				'desc' 		=> esc_html__('Show Best Selling Products','wpgeneral'),
				'slug' 	  	=> 'wd_woocommcerce_product',
				'class' 	=> 'widget_best_selling_product woocommerce woocommerce',
			);
		...
		function widget( $args, $instance ) {
			...
			extract( $args );
			$title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Sales Off','wpgeneral') : $instance['title']);
	...
	?>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('type')); ?>"><?php esc_html_e( 'Type:','wpgeneral' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('show')); ?>"><?php esc_html_e( 'Show','wpgeneral' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php esc_html_e( 'Order by','wpgeneral' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php esc_html_e( 'Order','wpgeneral' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Number of products to show:','wpgeneral' ); ?></label>
