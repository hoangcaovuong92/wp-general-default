	...
	class WP_Widget_Recent_Post_Slider extends WP_Widget {
		function __construct() {
	    	$widget_setting = array(
				'name' 		=> esc_html__('WD - Recent Posts [Slider]','wpgeneral'),
				'desc' 		=> esc_html__('This widget show recent posts by slider.','wpgeneral'),
				...
				while( $the_query->have_posts()) { $the_query->the_post();
					...
					<div class="item<?php //if($i == 0) echo ' first';?><?php //if(++$i == $num_count) echo ' last';?>">
						<div class="detail">
							...
							<div class="author"><?php esc_html_e('POST BY','wpgeneral');?> <?php the_author_posts_link();?></div>
						</div><!-- .detail -->
