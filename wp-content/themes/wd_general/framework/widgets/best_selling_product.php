...
if(!class_exists('WP_Widget_Best_Selling_Product')){
	class WP_Widget_Best_Selling_Product extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			extract( $args );
			$title = apply_filters('widget_title', empty($instance['title_best_selling']) ? esc_html__('Best Selling Products','wpgeneral') : $instance['title_best_selling']);
	...
	?>
				<p><label for="<?php echo esc_attr($this->get_field_id('title_best_selling')); ?>"><?php esc_html_e( 'Title for best selling tab:','wpgeneral' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('best_selling_type')); ?>"><?php esc_html_e( 'Type:','wpgeneral' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('num_best_selling')); ?>"><?php esc_html_e( 'The number of best selling post','wpgeneral' ); ?>:</label>
