	...
	class WP_Widget_Ew_social extends WP_Widget {
		function __construct() {
	    	$widget_setting = array(
				'name' 		=> esc_html__('WD - Social Profiles','wpgeneral'),
				'desc' 		=> esc_html__('Display Social Profiles','wpgeneral'),
				'slug' 	  	=> 'ew_social',
				'class' 	=> 'widget_social',
			);
		...
		function widget( $args, $instance ) {
			...
			<div class="social-icons">
				...
				<ul>
					...
					<li class="icon-facebook"><a href="<?php echo esc_url("http://www.facebook.com/".$facebook_id); ?>" target="_blank" title="<?php esc_html_e('Become our fan', 'wpgeneral'); ?>" ><i class="fa fa-facebook"></i></a></li>				
					<?php endif; ?>
					
					<?php if(strlen(trim($twitter_id)) > 0):?>
					<li class="icon-twitter"><a href="<?php echo esc_url("http://twitter.com/".$twitter_id); ?>" target="_blank" title="<?php esc_html_e('Follow us', 'wpgeneral'); ?>" ><i class="fa fa-twitter"></i></a></li>
					<?php endif; ?>
					
					<?php if(strlen(trim($google_id)) > 0):?>
					<li class="icon-google"><a href="<?php echo esc_url("https://plus.google.com/u/0/".$google_id); ?>" target="_blank" title="<?php esc_html_e('Get updates', 'wpgeneral'); ?>" ><i class="fa fa-google-plus"></i></a></li>
					<?php endif; ?>
					
					<?php if(strlen(trim($pin_id)) > 0):?>
					<li class="icon-pin"><a href="<?php echo esc_url("http://www.pinterest.com/".$pin_id);?>" target="_blank" title="<?php esc_html_e('See Us', 'wpgeneral'); ?>" ><i class="fa fa-pinterest"></i></a></li>
					<?php endif; ?>
					
					<?php if(strlen(trim($instagram_id)) > 0):?>
					<li class="icon-instagram"><a href="<?php echo esc_url("http://instagram.com/".$instagram_id); ?>" target="_blank" title="<?php esc_attr_e('Follow us', 'wpgeneral'); ?>" ><i class="fa fa-instagram"></i></a></li>
					<?php endif; ?>
					
					<?php if(strlen(trim($youtube_id)) > 0):?>
					<li class="icon-youtube"><a href="<?php echo esc_url("http://www.youtube.com/".$youtube_id); ?>" target="_blank" title="<?php esc_attr_e('Subscribe our channel', 'wpgeneral'); ?>" ><i class="fa fa-youtube"></i></a></li>
					<?php endif; ?>
					
					<?php if(strlen(trim($linkedin_id)) > 0):?>
					<li class="icon-linkedin"><a href="<?php echo esc_url("https://www.linkedin.com/pub/".$linkedin_id); ?>" target="_blank" title="<?php esc_attr_e('See us', 'wpgeneral'); ?>" ><i class="fa fa-linkedin"></i></a></li>
					<?php endif; ?>
				</ul>
			</div>
		...
		?>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('facebook_id')); ?>"><?php esc_html_e('Enter your Facebook ID','wpgeneral'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('twitter_id')); ?>"><?php esc_html_e('Enter your Twitter ID','wpgeneral'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('google_id')); ?>"><?php esc_html_e('Enter your Google+ ID','wpgeneral'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('pin_id')); ?>"><?php esc_html_e('Enter your Pinterest ID','wpgeneral'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('instagram_id')); ?>"><?php esc_html_e('Enter your Instagram','wpgeneral'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('youtube_id')); ?>"><?php esc_html_e('Enter your Youtube','wpgeneral'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('linkedin_id')); ?>"><?php esc_html_e('Enter your Linkedin','wpgeneral'); ?> : </label>
