...
<div class="select-layout area-config area-config1">
	<div class="area-inner">
		<div class="area-inner1">
			<h3 class="area-title"><?php esc_html_e('Custom Layout','wpgeneral'); ?></h3>
			<?php $this->tvlgiao_wpdance_showTooltip(esc_html__("Custom Layout",'wpgeneral'),esc_html__('Select custom layout for product page.Using general product page config by default','wpgeneral')); ?>
