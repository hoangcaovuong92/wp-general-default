...
<div class="select-layout area-config area-config1">
	<div class="area-inner">
		<div class="area-inner1">
			<h3 class="area-title"><?php esc_html_e('Additional Information','wpgeneral'); ?></h3>
			<?php $this->tvlgiao_wpdance_showTooltip(esc_html__("Additional Information",'wpgeneral'),esc_html__('This content show on top of left/right sidebar. Product must have a sidebar.','wpgeneral')); ?>
			...
			<div class="wd_area-content">
										...
										<div class="wd_item_ads">
											<div class="wd_ads_sidebar">
												<div class="wd_ads_remove_bt">
													<button type="button" class="button wd_remove_ads_sidebar"><?php esc_html_e( 'Remove', 'wpgeneral' ); ?></button>
												</div>	
												<div>
													<div class="wd_ads_title form-field">
														<div class="label"><label><?php esc_html_e( 'Title', 'wpgeneral' ); ?>:</label></div>
													...
													<div class="wd_ads_cont form-field" >
														<div class="label"><label><?php esc_html_e( 'Content', 'wpgeneral' ); ?>:</label></div>
													...
													<div class="wd_ads_pos form-field">
														<div class="label"><label><?php esc_html_e( 'Position', 'wpgeneral' ); ?>:</label></div>
				...
				<p class="wd_toolbar">
					<button type="button" class="button button-primary wd_add_new_ads_sidebar"><?php esc_html_e( 'Add', 'wpgeneral' ); ?></button>
				</p>				
