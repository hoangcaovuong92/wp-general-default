<?php 
class TvlgiaoWpdanceGeneralCustomFields extends TvlgiaoWpdanceGeneralAdminTheme 
{
	...
	public function tvlgiao_wpdance_deactive_err_revolu(){
	...
	*/ 
	...
	public function tvlgiao_wpdance_showbreakingnews(){
		require_once get_template_directory().'/framework/includes/metaboxes/showbreakingnews.php';
	}
