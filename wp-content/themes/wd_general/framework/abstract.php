<?php 
class TvlgiaoWpdanceGeneralTheme 
{
	...
	public function init(){
		...
		///// After Setup theme
		add_action( 'after_setup_theme', array($this,'TVLGiao_wpdance_setup'));
		...
		$classNameAdmin = 'TvlgiaoWpdanceGeneralAdminTheme';
	...
	protected function TVLGiao_Wpdance_initArrFunctions(){
		$this->arrFunctions = array('main','global_var','search','lightbox_control','breadcrumbs','sidebar','excerpt',/*'thumbnail',*/'pagination','theme_control','filter_theme','video','comment','theme_sidebar','custom_style','header_function','footer_function','wdmenus','woo-cart','woo-product','woo-hook','woo-account','custom_term', 'woo-wishlist', 'loading_page', 'ajax_function', 'video');
	}
	
	
	protected function TVLGiao_wpdance_initArrWidgets(){
		$this->arrWidgets = array('customrecent','custompages','ew_multitab'
								,'recent_comments_custom','ew_social','productaz','ew_subscriptions', 'best_selling_product', 'wd_woo_products', 'hot_product', 'recent_product');
	}
	...
	public function TVLGiao_wpdance_setup() {
		...
		load_theme_textdomain( 'wpgeneral', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Navigation', 'wpgeneral' )
		) );
		
		register_nav_menus( array(
			'mobile' =>  esc_html__( 'Mobile Navigation', 'wpgeneral' )
		) );
		
		register_nav_menus( array(
			'vertical_menu' =>  esc_html__( 'Vertical Navigation', 'wpgeneral' )
		) );
	...
	protected function constant($options){
		...
		define('TVLGiao_Wpdance_THEME_NAME', $options['tvlgiao_wpdance_theme_name']);
		...
		define('TVLGiao_Wpdance_THEME_INCLUDES_AJAX', TVLGiao_Wpdance_THEME_INCLUDES . '/ajax');
		...
		define('TVLGiao_Wpdance_THEME_EXTENSION', TVLGiao_Wpdance_THEME_FRAMEWORK . '/extension');
		
		define('TVLGiao_Wpdance_THEME_EXTENDS_EXTENDVC_URI', TVLGiao_Wpdance_THEME_FRAMEWORK.'/extendvc');
		
		define('TVLGiao_Wpdance_THEME_IMAGES', TVLGiao_Wpdance_THEME_URI . '/images');
	...
	public function TVLGiao_Wpdance_hookDeactive($code, $function) {
		...
		$fn=create_function('$tvlgiao_wpdance_theme', ' call_user_func($GLOBALS["wp_register_theme_deactivation_hook_function' . $code . '"]); delete_option("theme_is_activated_' . $code. '");');
	...
	public function  TVLGiao_Wpdance_addTailScripts(){
		...
		wp_register_style( 'tvlgiao-wpdance-custom_default', TVLGiao_Wpdance_THEME_CSS.'/custom_default.less');
		wp_enqueue_style('tvlgiao-wpdance-custom_default');	
		
		

		wp_register_script( 'tvlgiao-wpdance-less', TVLGiao_Wpdance_THEME_JS.'/less.js');
		wp_enqueue_script('tvlgiao-wpdance-less');	
	}
	
	public function  TVLGiao_Wpdance_addLastScripts(){
		if(is_rtl()) {
			wp_register_style( 'tvlgiao-wpdance-rtl', TVLGiao_Wpdance_THEME_CSS.'/wd_rtl.css');
			wp_enqueue_style('tvlgiao-wpdance-rtl');
		}
	}
	public function TVLGiao_Wpdance_addScripts(){
		...
		$query_args = array(
		'family' => 'Quicksand:400,300,700|Istok+Web:400,700|Archivo+Narrow:400,700'
		 );
		...
		wp_register_style( 'tvlgiao-wpdance-bootstrap', TVLGiao_Wpdance_THEME_CSS.'/bootstrap.css');
		wp_enqueue_style('tvlgiao-wpdance-bootstrap');
		
		wp_register_style( 'tvlgiao-wpdance-bootstrap-theme', TVLGiao_Wpdance_THEME_CSS.'/bootstrap-theme.css');
		wp_enqueue_style('tvlgiao-wpdance-bootstrap-theme');
		
		wp_enqueue_style( 'tvlgiao-wpdance-default', get_stylesheet_uri() ); 
		wp_register_style( 'tvlgiao-wpdance-reset', TVLGiao_Wpdance_THEME_CSS.'/reset.css');
		wp_enqueue_style('tvlgiao-wpdance-reset');
		wp_register_style( 'tvlgiao-wpdance-flexslider', TVLGiao_Wpdance_THEME_CSS.'/flexslider.css');
		wp_enqueue_style('tvlgiao-wpdance-flexslider');
		...
		wp_register_style( 'tvlgiao-wpdance-font-awesome', TVLGiao_Wpdance_THEME_FRAMEWORK_URI.'/css/font-awesome.css');
		wp_enqueue_style('tvlgiao-wpdance-font-awesome');
		wp_register_style( 'tvlgiao-wpdance-base', TVLGiao_Wpdance_THEME_CSS.'/base.css');
		wp_enqueue_style('tvlgiao-wpdance-base');
		wp_register_style( 'tvlgiao-wpdance-wd-widget', TVLGiao_Wpdance_THEME_CSS.'/widget.css');
		wp_enqueue_style('tvlgiao-wpdance-wd-widget');
		wp_register_style( 'tvlgiao-wpdance-select2', TVLGiao_Wpdance_THEME_CSS.'/select2.css');
		wp_enqueue_style('tvlgiao-wpdance-select2');
		wp_register_style( 'tvlgiao-wpdance-nivo-slider-css', TVLGiao_Wpdance_THEME_CSS.'/nivo-slider.css');
		wp_enqueue_style('tvlgiao-wpdance-nivo-slider-css');	
		wp_register_style( 'tvlgiao-wpdance-cs-animate', TVLGiao_Wpdance_THEME_CSS.'/cs-animate.css');
		wp_enqueue_style('tvlgiao-wpdance-cs-animate');
		...
		wp_register_style( 'tvlgiao-wpdance-responsive', TVLGiao_Wpdance_THEME_CSS.'/responsive.css');
		wp_enqueue_style('tvlgiao-wpdance-responsive');
		
		wp_enqueue_script('jquery');	
		wp_register_script( 'tvlgiao-wpdance-bootstrap', TVLGiao_Wpdance_THEME_JS.'/bootstrap.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-bootstrap');		
		wp_register_script( 'tvlgiao-wpdance-TweenMax', TVLGiao_Wpdance_THEME_JS.'/TweenMax.min.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-TweenMax');
		
		wp_enqueue_script('tvlgiao-wpdance-flexslider-js',TVLGiao_Wpdance_THEME_JS.'/jquery.flexslider-min.js',false,true);

		wp_register_script( 'tvlgiao-wpdance-bootstrap-colorpicker', TVLGiao_Wpdance_THEME_JS.'/bootstrap-colorpicker.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-bootstrap-colorpicker');	
		
		wp_register_script( 'tvlgiao-wpdance-include-script', TVLGiao_Wpdance_THEME_JS.'/include-script.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-include-script');

		wp_register_script( 'tvlgiao-wpdance-jquery.carouFredSel', TVLGiao_Wpdance_THEME_JS.'/jquery.carouFredSel-6.2.1.min.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-jquery.carouFredSel');

		wp_register_script( 'tvlgiao-wpdance-owl.carousel', TVLGiao_Wpdance_THEME_JS.'/owl.carousel.min.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-owl.carousel');
			
		wp_register_script( 'tvlgiao-wpdance-jquery.select2', TVLGiao_Wpdance_THEME_JS.'/select2.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-jquery.select2');

		wp_register_script( 'tvlgiao-wpdance-jquery.nivo-js', TVLGiao_Wpdance_THEME_JS.'/jquery.nivo.slider.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-jquery.nivo-js');		

		wp_register_script( 'tvlgiao-wpdance-jquery-appear', TVLGiao_Wpdance_THEME_JS.'/jquery.appear.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-jquery-appear');
		
		wp_register_script( 'tvlgiao-wpdance-isotope-min', TVLGiao_Wpdance_THEME_JS.'/isotope.min.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-isotope-min');
		
		
		if(is_singular('product')){
			wp_register_script( 'tvlgiao-wpdance-jquery.cloud-zoom', TVLGiao_Wpdance_THEME_JS.'/cloud-zoom.1.0.2.js',false,false,true);
			wp_enqueue_script('tvlgiao-wpdance-jquery.cloud-zoom');		
			wp_register_style( 'tvlgiao-wpdance-cloud-zoom-css', TVLGiao_Wpdance_THEME_CSS.'/cloud-zoom.css');
			wp_enqueue_style('tvlgiao-wpdance-cloud-zoom-css');
		
		}else{
			wp_register_script( 'tvlgiao-wpdance-jquery.prettyPhoto', TVLGiao_Wpdance_THEME_JS.'/jquery.prettyPhoto.min.js',false,false,true);
			wp_enqueue_script('tvlgiao-wpdance-jquery.prettyPhoto');	
			wp_register_script( 'tvlgiao-wpdance-jquery.prettyPhoto.init', TVLGiao_Wpdance_THEME_JS.'/jquery.prettyPhoto.init.min.js',false,false,true);
			wp_enqueue_script('tvlgiao-wpdance-jquery.prettyPhoto.init');				
			wp_register_style( 'tvlgiao-wpdance-css.prettyPhoto', TVLGiao_Wpdance_THEME_CSS.'/prettyPhoto.css');
		...
		if(!is_admin()){		
			if(wp_is_mobile()) {
				wp_register_script( 'tvlgiao-wpdance-mobile-jquery', TVLGiao_Wpdance_THEME_JS.'/jquery.mobile.min.js',false,false,true);
				wp_enqueue_script('tvlgiao-wpdance-mobile-jquery');
				
				wp_register_script( 'tvlgiao-wpdance-mobile-event', TVLGiao_Wpdance_THEME_JS.'/mobile-event.js',false,false,true);
				wp_enqueue_script('tvlgiao-wpdance-mobile-event');
			}
			
			
			wp_register_script( 'tvlgiao-wpdance-main-js', TVLGiao_Wpdance_THEME_JS.'/main.js',false,false,true);
			...
			if(isset($tvlgiao_wpdance_wd_data['wd_smooth_scroll']) && absint($tvlgiao_wpdance_wd_data['wd_smooth_scroll']) == 1){
				if(!wp_is_mobile()) {
					if($this->TVLGiao_Wpdance_is_windows() && $this->TVLGiao_Wpdance_is_chrome()) {
						wp_register_script( 'tvlgiao-wpdance-smooth-scroll', TVLGiao_Wpdance_THEME_JS.'/smoothScroll.js',false,false,true);
						wp_enqueue_script('tvlgiao-wpdance-smooth-scroll');
					}
				}
			}
			...
			if(isset($tvlgiao_wpdance_wd_data['wd_loading_page']) && absint($tvlgiao_wpdance_wd_data['wd_loading_page']) == 1){ 
				if(!wp_is_mobile()) { 
					wp_register_style( 'tvlgiao-wpdance-pace-page', TVLGiao_Wpdance_THEME_CSS.'/pace.page.css');
					wp_enqueue_style('tvlgiao-wpdance-pace-page');
					wp_register_script( 'tvlgiao-wpdance-pace-min', TVLGiao_Wpdance_THEME_JS.'/pace.min.js',false,false,true);
					wp_enqueue_script('tvlgiao-wpdance-pace-min');
				}
			}
		}
	...
	public function TVLGiao_Wpdance_wd_vcSetAsTheme() {
		vc_set_as_theme();
	}
	...
	protected function TVLGiao_Wpdance_extendVC(){
		...
		if (class_exists('Vc_Manager')) {
			...
			add_action( 'vc_before_init',array($this,'TVLGiao_Wpdance_wd_vcSetAsTheme'));
			
			vc_set_shortcodes_templates_dir(TVLGiao_Wpdance_THEME_DIR ."/framework/extension/extendvc/vc_templates");
			
			vc_disable_frontend();

			$this->TVLGiao_Wpdance_changing_rows_columns_classes();
		}
	...
	public function TVLGiao_Wpdance_changing_rows_columns_classes(){
	...
	function TVLGiao_Wpdance_loadImageSize(){
		if ( function_exists( 'add_image_size' ) ) {
		   // Add image size for main slideshow
			...
			$wd_single_products_thumbnail_width = ( isset($tvlgiao_wpdance_wd_data['wd_single_products_thumbnail_width']) && absint($tvlgiao_wpdance_wd_data['wd_single_products_thumbnail_width']) > 0 )? absint($tvlgiao_wpdance_wd_data['wd_single_products_thumbnail_width']) : 100;
			$wd_single_products_thumbnail_height = ( isset($tvlgiao_wpdance_wd_data['wd_single_products_thumbnail_height']) && absint($tvlgiao_wpdance_wd_data['wd_single_products_thumbnail_height']) > 0 )? absint($tvlgiao_wpdance_wd_data['wd_single_products_thumbnail_height']) : 140;
			...
			add_image_size('tvlgiao_wpdance_single_product_thumbnail_',$wd_single_products_thumbnail_width,$wd_single_products_thumbnail_height,true);
			add_image_size('tvlgiao_wpdance_sub_categories_thumbnail',$wd_product_subcategories_thumbnail_width,$wd_product_subcategories_thumbnail_height,true); /* image for single product detail */
			add_image_size('tvlgiao_wpdance_categories_thumbnail',$wd_product_categories_shortcode_thumbnail_width,$wd_product_categories_shortcode_thumbnail_height,true); /* image for single product detail */
			
			add_image_size('tvlgiao_wpdance_gallery_1', 600, 600, true);
			add_image_size('tvlgiao_wpdance_gallery_2', 600, 300, true);
			add_image_size('tvlgiao_wpdance_gallery_3', 300, 300, true);
...
class TvlgiaoWpdanceClassNameVar
{
	...
	{
        global $tvlgiao_wpdance_xml_headers;
		$tvlgiao_wpdance_xml_headers = $name;
	}
