...
<?php
	...
	$slideshow_show = (!is_page() || (!isset($tvlgiao_wpdance_page_datas['toggle_vertical_menu']) || absint($tvlgiao_wpdance_page_datas['toggle_vertical_menu']) == 1 ) )? false: true;
?>
	...
	<div id="content-inner" class="row">
		<div class="header-static-slideshow">
			<div class="row">
				...
				<div class="static_slideshow col-sm-12">
					<?php if(isset($tvlgiao_wpdance_page_datas['page_slider']) && $tvlgiao_wpdance_page_datas['page_slider'] != 'none'){
