	...
	if(have_posts()) : while(have_posts()) : the_post(); $post = TvlgiaoWpdanceClassNameVar::TVLGiao_wpdance_GetVar("post");$count++; $wp_query = TvlgiaoWpdanceClassNameVar::TVLGiao_wpdance_GetVar("wp_query");
		...
		<li <?php post_class("home-features-item". esc_attr($_sub_class));?>>
			...
			<div class="post-info-content">
				...
				?>
					<div class="short-content"><?php tvl_wpdance_the_excerpt_max_words($words_limit,$post); ?></div>
				<?php endif; ?>
				<?php if( $tvlgiao_wpdance_wd_data['wd_blog_readmore'] == 1 ) : ?>
					<div class="read-more"><a class="button" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read more','wpgeneral'); ?></a></div>
				<?php endif; ?>					
