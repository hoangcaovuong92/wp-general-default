...
class Options_Machine {
		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'backup':
					...
					$output .= '<p><strong>'. esc_html__('Last Backup : ','wpgeneral').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
	...
	public static function optionsframework_import_function($id){
		...
		ob_start();
		?>
			<button style="position:relative; display: inline-table; margin: 0px auto;" data-pa-id="<?php echo esc_attr($id);?>" data-id="<?php echo esc_attr($id);?>_import" type="button" class="button wp_import_button" name="<?php echo esc_attr($id);?>_import_btn"><i class="fa fa-upload"></i> <?php esc_html_e('Import', "wpgeneral")?></button>
			...
			<button style="position:relative; display: inline-table;" data-pa-id="<?php echo esc_attr($id);?>" data-action="<?php echo TVLGiao_Wpdance_ADMIN_DIR?>classes/export_xml.php" type="button" class="button-primary wp_export_input" name="<?php echo esc_attr($id);?>_export" title="<?php esc_html_e('Exporting the colour being applied', "wpgeneral")?>" id="<?php echo esc_attr($id);?>_export"><i class="fa fa-download"></i> <?php esc_html_e('Export', "wpgeneral")?></button>
			<button style="position:relative; display: inline-table;" type="button" class="button-remove wp_remove_button" data-pa-id="<?php echo esc_attr($id);?>" name="<?php echo esc_attr($id);?>_remove" id="<?php echo esc_attr($id);?>_remove"><i class="fa fa-trash-o"></i> <?php esc_html_e('Remove', "wpgeneral")?></button>
		<?php
