...
$of_options[] = array( 	"name" 		=> "Header Layout"
						...
						,"type" 	=> "images"
						,"options" 	=> array(
							'v4' 	=> ADMIN_ASSETS_IMG_DIR . 'header/header-v1.jpg'							
						)
				);
...
$of_options[] = array( 	"name" 		=> "Tini cart style"
						...
						,"std" 		=> "0"
						,"desc" 	=> "Having two options, which are sidebar or hover popup."
...
$of_options[] = array( 	"name" 		=> "Forum"
						,"type" 	=> "heading"
						,"icon"		=> TVLGiao_Wpdance_ADMIN_IMAGES . "slider-control.png"
				);
...
$of_options[] = array( 	"name" 		=> "Related Product Title"
						...
						,"std" 		=> esc_html__('RELATED ITEMS','wpgeneral')
...
$of_options[] = array( 	"name" 		=> "Upsell Product Title"
						...
						,"std" 		=> esc_html__('YOU MAY ALSO LIKE','wpgeneral')
						,"fold" 	=> "wd_prod_upsell"
						,"type" 	=> "text"
				);			
...
$of_options[] = array( 	"name" 		=> "Blog Related Label"
						...
						,"std" 		=> esc_html__("Related Posts","wpgeneral")
