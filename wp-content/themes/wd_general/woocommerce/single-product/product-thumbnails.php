				...
				<?php 
					...
					foreach ( $attachment_ids as $attachment_id ) {
						...
						if($tvlgiao_wpdance_wd_data['wd_prod_cloudzoom'] == 1){
							...
							$image       = wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_small_thumbnail_size', 'tvlgiao_wpdance_single_product_thumbnail_' ),array( 'alt' => $image_title, 'title' => $image_title ) );
							...
							$image       = wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_small_thumbnail_size', 'tvlgiao_wpdance_single_product_thumbnail_' ) );
