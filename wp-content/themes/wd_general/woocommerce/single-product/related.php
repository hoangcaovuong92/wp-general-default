...
if ( $products->have_posts() ) : ?>
	...
	<div class="related grid">
		...
		<h3 class="heading-title"><?php echo esc_attr($related_title = sprintf( esc_html__( '%s','wpgeneral' ), stripslashes(esc_html($tvlgiao_wpdance_wd_data['wd_prod_related_title'])) )); ?></h3>
