		...
		<div class="grouped_product_item">
			...
			<table class="variations" cellspacing="0">
				<tbody>
					...
					<tr>
						<td class="label"><label class="bold-upper" for="pa_size"><?php esc_html_e('Price','wpgeneral');?></label></td>
						<td>
							<?php
					...
					<tr>
						<td class="label"><label class="bold-upper" for="pa_size"><?php esc_html_e('Quanglity','wpgeneral');?></label></td>
						<td>
