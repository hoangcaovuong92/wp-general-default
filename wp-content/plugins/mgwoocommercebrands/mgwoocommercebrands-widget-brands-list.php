...
class mgwoocommercebrands_list_widget extends WP_Widget {
	function __construct() {
    	$widget_setting = array(
			'name' 		=> esc_html__('WooCommerce Brands list','wpdance'),
			'desc' 		=> esc_html__('Display a list of your brands on your site','wpdance'),
			'slug' 	  	=> 'mgwoocommercebrands_list_widget',
			'class' 	=> 'mgwoocommercebrands_class',
		);
