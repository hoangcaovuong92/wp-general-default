 ...
 */
	if(!function_exists('wd_custom_products_category_function')){
		function wd_custom_products_category_function($atts,$content){
			...
			if ( ! $category ) return;
			wp_reset_query(); 
			global $featured_datas,$tvlgiao_wpdance_wd_data,$product,$post;
			...
			if(isset($tvlgiao_wpdance_wd_data['wd_prod_cat_column']) && absint($tvlgiao_wpdance_wd_data['wd_prod_cat_column']) > 0 ){
				...
				$tvlgiao_wpdance_wd_data['wd_prod_cat_column'] = 3;
			} 
			...
			?>
					...
					<?php
						...
						if($_count == 0){
							...
							$old_data = $tvlgiao_wpdance_wd_data['wd_prod_cloudzoom'];
							$tvlgiao_wpdance_wd_data['wd_prod_cloudzoom'] = 0;
							if(!isset($_featured_prod)){
								$featured_datas['id'] = $product->get_id();
							...
							<?php 
								...
								if(!isset($tvlgiao_wpdance_wd_data['wd_catelog_mod']) || (isset($tvlgiao_wpdance_wd_data['wd_catelog_mod']) && $tvlgiao_wpdance_wd_data['wd_catelog_mod'] == 1)){
							?>
							...
							$tvlgiao_wpdance_wd_data['wd_prod_cloudzoom'] = $old_data;
	...
	if(!function_exists('wd_custom_products_category_style2_function')){
		function wd_custom_products_category_style2_function($atts,$content){
			...
			global $woocommerce, $woocommerce_loop,$tvlgiao_wpdance_wd_data;
			if ( empty( $atts ) ) return;
			extract( shortcode_atts( array(
				'per_page' 		=> '4'
				,'orderby'   	=> 'title'
			...
			if(isset($tvlgiao_wpdance_wd_data['wd_prod_cat_column']) && absint($tvlgiao_wpdance_wd_data['wd_prod_cat_column']) > 0 ){
				$_old_wd_prod_cat_column = $tvlgiao_wpdance_wd_data['wd_prod_cat_column'];
				$tvlgiao_wpdance_wd_data['wd_prod_cat_column'] = 2;
			} 
