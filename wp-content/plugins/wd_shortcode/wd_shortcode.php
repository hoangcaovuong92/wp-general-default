...
class WD_Shortcode
{
	...
	public function init_script(){
		...
		wp_register_style( 'tvlgiao-wpdance-shop_shortcode', SC_CSS.'/shop_shortcode.css');
		wp_enqueue_style('tvlgiao-wpdance-shop_shortcode');
		
		wp_register_style( 'tvlgiao-wpdance-blog_shortcode', SC_CSS.'/blog_shortcode.css');
		wp_enqueue_style('tvlgiao-wpdance-blog_shortcode');
		
		wp_register_style( 'tvlgiao-wpdance-bootstrap', SC_CSS.'/bootstrap.css');
		wp_enqueue_style('tvlgiao-wpdance-bootstrap');
		
		wp_register_style( 'tvlgiao-wpdance-bootstrap-theme', SC_CSS.'/bootstrap-theme.css');
		wp_enqueue_style('tvlgiao-wpdance-bootstrap-theme');
		
		wp_register_style( 'tvlgiao-wpdance-css.countdown', SC_CSS.'/jquery.countdown.css');
		wp_enqueue_style('tvlgiao-wpdance-css.countdown');
		
		wp_register_style( 'tvlgiao-wpdance-owl.carousel', SC_CSS.'/owl.carousel.min.css');
		wp_enqueue_style('tvlgiao-wpdance-owl.carousel');	
				
		wp_register_script( 'tvlgiao-wpdance-bootstrap', SC_JS.'/bootstrap.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-bootstrap');
		
		wp_register_script( 'tvlgiao-wpdance-wd_shortcode', SC_JS.'/wd_shortcode.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-wd_shortcode');
		...
		wp_register_script( 'tvlgiao-wpdance-jquery.countdown', SC_JS.'/jquery.countdown.js',false,false,true);
		wp_enqueue_script('tvlgiao-wpdance-jquery.countdown');
		
		wp_register_script( 'tvlgiao-wpdance-owl.carousel', SC_JS.'/owl.carousel.min.js',false,false,true);
