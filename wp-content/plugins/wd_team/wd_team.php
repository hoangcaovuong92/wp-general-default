...
class WD_Team {
	...
	public function wd_team_template_redirect(){
		global $wp_query,$post,$tvlgiao_wpdance_page_datas,$data;
	...
	public function init_script(){
		...
		wp_register_style( 'tvlgiao-wpdance-bootstrap', WDT_CSS.'/bootstrap.css');
		...
		wp_register_script( 'tvlgiao-wpdance-bootstrap', WDT_JS.'/bootstrap.js');
		wp_enqueue_script('tvlgiao-wpdance-bootstrap');
		
		
		wp_register_script( 'tvlgiao-wpdance-jquery.carouFredSel', WDT_JS.'/jquery.carouFredSel-6.2.1.min.js',false,false,true);
