	...
	if (!class_exists('WD_List_Grid')) {
		...
		class WD_List_Grid {
			...
			function setup_scripts_styles() {
				...
				if ( is_shop() || is_product_category() || is_product_tag() || is_product_taxonomy() ) {
					wp_enqueue_style( 'tvlgiao-wpdance-jquery.isotope', plugins_url( '/assets/css/jquery.isotope.css', __FILE__ ) );
					wp_enqueue_style( 'gl-css', plugins_url( '/assets/css/style.css', __FILE__ ) );
				}
			}
			function setup_scripts_script() {
				if ( is_shop() || is_product_category() || is_product_tag() || is_product_taxonomy() ) {
					wp_enqueue_script( 'tvlgiao-wpdance-cookie', plugins_url( '/assets/js/jquery.cookie.min.js', __FILE__ ), array( 'jquery' ) );
					wp_enqueue_script( 'tvlgiao-wpdance-grid-list-scripts', plugins_url( '/assets/js/jquery.gridlistview.js', __FILE__ ), array( 'jquery' ) );
					wp_enqueue_script( 'tvlgiao-wpdance-jquery.imagesloaded', plugins_url( '/assets/js/jquery.imagesloaded.min.js', __FILE__ ), array( 'jquery' ) );
					wp_enqueue_script( 'tvlgiao-wpdance-jquery.isotope', plugins_url( '/assets/js/jquery.isotope.min.js', __FILE__ ), array( 'jquery' ) );
