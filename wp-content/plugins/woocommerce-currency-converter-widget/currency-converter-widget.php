...
class WooCommerce_Widget_Currency_Converter extends WP_Widget {
	function __construct() {
    	$widget_setting = array(
			'name' 		=> esc_html__('WooCommerce Currency Converter','wc_currency_converter'),
			'desc' 		=> esc_html__('Allow users to choose a currency for prices to be displayed in.','wc_currency_converter'),
			'slug' 	  	=> 'woocommerce_currency_converter',
			'class' 	=> 'widget_currency_converter',
		);
