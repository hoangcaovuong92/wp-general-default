...
if( !class_exists( 'WD_Popup' ) ) {
	class WD_Popup {
		...
		public function wp_script_font(){
			...
			wp_register_script('tvlgiao-wpdance-wd_bpopup_min', WD_URL_ASSESTS . 'js/jquery.bpopup.min.js', 'jquery', '1.1',false);
			wp_enqueue_script('tvlgiao-wpdance-wd_bpopup_min');
			
			wp_register_script('tvlgiao-wpdance-wd_popup_font', WD_URL_ASSESTS . 'js/wd-popup.js', 'jquery', '1.1',false);
			wp_enqueue_script('tvlgiao-wpdance-wd_popup_font');
			
			wp_register_style( 'tvlgiao-wpdance-wd_fa_css', '//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css', false, false );
			wp_enqueue_style( 'tvlgiao-wpdance-wd_fa_css' );
			
			wp_register_style( 'tvlgiao-wpdance-wd_pp_css', WD_URL_ASSESTS . 'css/wd-pp.style.css', false, false );
			wp_enqueue_style( 'tvlgiao-wpdance-wd_pp_css' );
